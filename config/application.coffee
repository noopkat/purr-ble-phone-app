...
steroids.config.name = "steroidshello"

# -- Initial Location --
steroids.config.location = "http://localhost/cameraExample.html"
...
# steroids.config.tabBar.tintColor = "#ff0000"
# steroids.config.tabBar.tabTitleColor = "#ff0000"
